...
%changelog
* Fri Sep 18 2026 gmipf <gmipf64@gmail.com> - 0.119.0-1
- Automated sync to upstream grype release v0.119.0; re-vendored linux_amd64 tarball (SHA256-verified), Release reset to 1.

* Fri Aug 28 2026 gmipf <gmipf64@gmail.com> - 0.118.0-1
- Automated sync to upstream grype release v0.118.0; re-vendored linux_amd64 tarball (SHA256-verified), Release reset to 1.
...
* Fri Jul 17 2026 gmipf <gmipf64@gmail.com> - 0.116.0-1
- Automated sync to upstream grype release v0.116.0; re-vendored linux_amd64 tarball (SHA256-verified), Release reset to 1.
